...
const EditElectronicdata = () => {
  ...
  const indiData = async () => {
    const res = await fetch(`/getelectronicsone/${id}`, {
      method: "GET",
      headers: {
  ...
  const btnn = async () => {
    ...
    const res = await fetch(`/editelectronic/${id}`, {
      method: "PUT",
      headers: {
        "Content-Type": "application/json",
      },
          ...
          <div style={{ display: "flex", justifyContent: "space-between" }}>
            <div>
              <NavLink to="/editelectronic">
                <button className="pro_manage">Edit Electronic page</button>
              </NavLink>
            </div>
            <div>
...
export default EditElectronicdata;

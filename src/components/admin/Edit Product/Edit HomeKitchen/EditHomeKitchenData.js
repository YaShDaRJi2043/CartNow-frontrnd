...
const EditHomeKitchenData = () => {
  ...
  const indiData = async () => {
    const res = await fetch(`/gethomekitchensone/${id}`, {
      method: "GET",
      headers: {
  ...
  const btnn = async () => {
    ...
    const res = await fetch(`/edithomekitchen/${id}`, {
      method: "PUT",
      headers: {
        "Content-Type": "application/json",
      },
          ...
          <div style={{ display: "flex", justifyContent: "space-between" }}>
            <div>
              <NavLink to="/edithomekitchen">
                <button className="pro_manage">Edit Homekitchen page</button>
              </NavLink>
            </div>
            <div>
...
export default EditHomeKitchenData;
